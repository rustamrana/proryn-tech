...
export const NAV_LINKS: NavItem[] = [
  ...
  },
  {
    ...
    href: "/applications",
    children: [
      { label: "CRM", href: "/applications/crm" },
      { label: "Sales", href: "/applications/sales" },
      { label: "Inventory", href: "/applications/inventory" },
      { label: "HRMS", href: "/applications/hrms" },
      { label: "Projects", href: "/applications/projects" },
      { label: "Helpdesk", href: "/applications/helpdesk" },
      { label: "Document Management", href: "/applications/documents" },
